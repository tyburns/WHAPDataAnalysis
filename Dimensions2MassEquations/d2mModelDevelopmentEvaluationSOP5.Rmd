...
boot1.wg <- lme4::bootMer(wg_d2m_m2,
                       myPred,
                       nsim = 1000,
                       use.u = FALSE,
                       type = "parametric")
...
Coefficients of variation for watergrass are small to medium range. The margin of error (half CI width) is in the order of 145%,
