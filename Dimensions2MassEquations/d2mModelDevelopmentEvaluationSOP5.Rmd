...
In this approach, the question of whether a new refuge or year need to be sampled can be addressed by exploring the magnitude of group-level variance in slope and intercept.
...
scatterplot(log_mass_mg ~ fitted(st_d2m_m3) | LIT_yr,
            smooth = FALSE,
            data = st_d2m)
abline(0, 1, lty = 2)
...
The graphical display of group effects on intercept and slope
