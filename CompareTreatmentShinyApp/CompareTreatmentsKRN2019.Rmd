...
brm1 <- brm(st_g_m2 ~ act * y.flooded.15,
            data = qdt_mass_act_fld,
            iter = 4000,
            warmup = 1500,
            thin = 2,
...
There is a clear difference between units that were disced and those that were not. The posterior median difference is 168 g/m2 with a standard error of 25.7 g/m2.
