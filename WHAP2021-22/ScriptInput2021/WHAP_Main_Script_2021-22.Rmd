...
cps <- cps0 %>%
  ...
  mutate(level = "CP", # this could be achieved with acomp()
         ...
         p_wg_b.Med = pVA_Watergrass_medium / temp_p,
         p_wg_c.High = pVA_Watergrass_high / temp_p,
         p_st_a.Low = pVA_Swamp_Timothy_low / temp_p,
         p_st_b.Med = pVA_Swamp_Timothy_medium / temp_p,
         p_st_c.High = pVA_Swamp_Timothy_high / temp_p,
         p_sw_a.Low = pVA_Smartweed_low / temp_p,
         p_sw_b.Med = 0,
         p_sw_c.High = 0,
         p_noFood = pVA_Other_cover_NA / temp_p,
         subunit_ID = factor(paste(LIT, unitName, subunitName, sep = "_")),
