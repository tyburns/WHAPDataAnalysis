...
st_all_noO <- readRDS("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/st_all_noO.rds") %>%
  rename_with(~gsub(".", "_", .x, fixed = TRUE))

# Data to create model for ST: mass = f(seed no., seed length)
# From wg_model_creation.R
wgdat <- readRDS("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/wgdat.rds") %>%
  rename_with(~gsub(".", "_", .x, fixed = TRUE))
...
vps <- read.csv("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/WHAP2019_PP_20201002_VPs.csv") %>%
  mutate(level = "VP",
...
cps <- read.csv("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/WHAP2019_PP_20201002_CPs.csv") %>%
  mutate(level = "CP",
         temp_p = Watergrass_Low +
           Watergrass_Med +
           Watergrass_High +
...
mus <- read.csv("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/WHAP2019_PP_20201002_MUs.csv") %>% # management units
  dplyr::select(LIT,
                Unit_Name,
                Subunit_Name,
                su.area_ac = Acreage) %>%
...
# Quadrat information ====================================
qdt_st <- read.csv("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/qdt2019c.csv") %>%
...
qdt_wg <- read.csv("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/qdt2019c.csv") %>%
...
su_areas <- read.csv("/Users/emilioalaca/Google Drive/Documents/PROJECTS/RefugesIMKaylene/WaterbirdHabitat2017/WHAPeal/WHAPDataAnalysis/SeedYieldData/WHAP2019_PP_20201002_MUs.csv") %>%
  dplyr::select(LIT,
                Unit_Name,
                Subunit_Name,
                area_ac = Acreage) %>%
...
The bootstrap samples are then summarized to produce percentile confidence intervals and averages of st, wg and total mass per m2.
