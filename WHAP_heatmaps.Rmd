...
```{r}
mus_krn <- read_sf('~/test/WHAP_mapping_2019/KRN_MU_2019.shp')
colnames(mus_krn)[colnames(mus_krn)=="SubUnit"] <- "Sub_Unit"
mus_pix <- read_sf('~/test/WHAP_mapping_2019/PIX_MU_2019.shp')
colnames(mus_pix)[colnames(mus_pix)=="UnitName"] <- "Sub_Unit"
#mus_mdc <- read_sf('MDC_MU_2019.shp')
mus_slw <- read_sf('~/test/WHAP_mapping_2019/SLW_MU_2019.shp')
colnames(mus_slw)[colnames(mus_slw)=="UnitName"] <- "Sub_Unit"
mus_mdc<-read_sf('~/test/Modoc_MU/Modoc_ManagementUnits_20210419.shp')
