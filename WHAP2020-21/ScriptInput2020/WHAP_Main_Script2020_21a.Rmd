---
title: "Calculation of Timothy and Watergrass seed abundance.Summer 2020a"
...
write.csv(qdt_mass_g_m2, "qdt_mass_g_m2_2020a.txt")
...
compare_su_mass %>%
  ...
  write_csv("CompareSTMassWithinRefuge_2020a.csv")

compare_su_mass %>%
  dplyr::select(wg_mass) %>%
  unnest(cols = c(wg_mass)) %>%
  write_csv("CompareWGMassWithinRefuge_2020a.csv")

compare_su_mass %>%
  dplyr::select(tot_mass) %>%
  unnest(cols = c(tot_mass)) %>%
  write_csv("CompareTotalMassWithinRefuge_2020a.csv")
...
write.csv(p_Area, "../Output2020a/p_Area2020a.csv")
...
write.csv(st_qdt_means,
          "../Output2020a/TimothyMassPerAreaByLITstratum2020a.csv")
...
write.csv(wg_qdt_means,
          "../Output2020a/WatergrassMassPerAreaByLITstratum2020a.csv")
...
saveRDS(qdt_mass_g_m2, "../Output2020a/qdt_mass_g_m2_2020a.rds")

# Save comparisons between units within refuge

saveRDS(compare_su_mass, "../Output2020a/compare_su_mass_2020a.rds")
